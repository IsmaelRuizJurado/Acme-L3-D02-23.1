...
@Service
public class AuthenticationLecturerCreateService extends AbstractService<Authenticated, Lecturer> {
	...
	public void load() {
		...
		userAccount = this.repository.getUserAccountById(userAccountId);
